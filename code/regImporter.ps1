...
if ([string]::IsNullOrWhiteSpace($ProfilePath)) {
    $jsonLocation = Join-Path $scriptDir 'profile.json'
...
} elseif ([string]::IsNullOrWhiteSpace($ProfilePath)) {
    try {
        $raw = (Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/SegoCode/RegImporter/main/code/profiles/privacy_profile.json').Content
    } catch {
